...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_education_above_50k / higher_education)*100, 2)
    lower_education_rich = round((lower_education_above_50k / lower_education)*100,2)
    ...
    rich_percentage = round((num_min_workers_above_50k / num_min_worker)*100,2)
